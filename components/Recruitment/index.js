      ...
      <div className="relative flex flex-col items-center text-[#191919] ">
        ...
        <div className="bg-[#191919] w-[350px] md:w-[410px] py-1 px-1 rounded-[36px] flex justify-between items-center mb-28 z-50">
          ...
          <button
            ...
            }  rounded-[36px] text-white hover:bg-white hover:text-black px-8 py-1 `}
          >
            ATS
          </button>
          <button
            ...
            } text-white rounded-[36px] hover:bg-white hover:text-black px-8 py-1 `}
          >
            Chat
          </button>
        </div>
      ...
      {dashboard && (
        <div className=" bg-img-dashboard h-72  md:h-[70vh] lg:h-[80vh] xl:h-screen w-full relative">
          <div className="absolute -bottom-0 left-[calc(100%-85%)]">
            <img
              className="w-48 md:w-80 md:h-60"
          ...
          <div className="absolute top-0 -right-16 md:top-24 lg:-top-32 lg:-bottom-32 md:-right-28">
            <img
              className="w-40 h-60 md:w-72 md:h-80 lg:w-72 lg:h-full "
      ...
      {chat && (
        <div className="bg-img-chat h-72  md:h-[70vh] lg:h-[80vh] xl:h-screen w-full relative rounded-2xl border-black border-t-8 border-r-8 border-l-8 border-solid">
          <div className="absolute top-0 -right-8 md:top-24   md:-right-28">
            <img
              className="w-52 h-80 md:hidden lg:flex lg:w-[450px] lg:h-[550px] xl:w-[550px] xl:h-[650px]"
            ...
            <div className="hidden md:flex lg:hidden">
              ...
              <div className="flex justify-center items-center absolute left-4 bottom-1 md:bottom-2 lg:bottom-8 px-4 py-1 md:py-2 rounded-3xl bg-[#69696999]">
                ...
                x``
                <div className="flex flex-col text-white ml-1 lg:ml-3">
                  <h2 className="text-[6px] md:text-xs font-medium">
                    Andrexa Davis
                  </h2>
                  <p className="text-[6px] md:text-[6px] font-light">
                    Graphic Designer
                  </p>
                </div>
              </div>
